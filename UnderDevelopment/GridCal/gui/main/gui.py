...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/file/ic_settings_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/file/ic_memory_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.TimeEventsTab, icon8, "")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/file/ic_insert_chart_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.ResultsTab, icon9, "")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/file/ic_autorenew_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/file/ic_file_upload_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_file.setIcon(icon11)
        self.actionOpen_file.setObjectName("actionOpen_file")
        self.actionSave = QtWidgets.QAction(mainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/file/ic_file_download_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionRevert_grid_to_initial_state.setIcon(icon10)
...
"last solution"))
        ...
        self.actionNew_project.setText(_translate("mainWindow", "新的项目"))
        ...
        self.actionPower_flow.setText(_translate("mainWindow", "潮流计算"))
        ...
        self.actionRevert_grid_to_initial_state.setText(_translate("mainWindow", "重置网络的显示状态"))
